...
exports.run = async (client, message, args) => {
  ...
  if (!abonelog)
    return message.channel.send(`❌ **__Abone log kanalı ayarlanmamış!__**`);
  if (!aboneyetkilisi)
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .addField(`🎃 Abone Rolünü Veren Kişi:`, `<@${message.author.id}>`, true)
    ...
    .setFooter(`${client.user.username} Kirtan | Abone Sistemi`);
